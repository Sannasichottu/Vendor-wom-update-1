  ...
  const columns = useMemo(
    () => [
          ...
          return (
            <div>
              <Stack direction="row" spacing={1.5} alignItems="center">
                ...
                <Avatar alt="Avatar" size="sm" src={'https://carorbis.com/wp-content/uploads/2021/05/Engine-Block.png'} />
                <Stack spacing={0}>
                  <Typography variant="subtitle1">Audi</Typography>
      ...
      },
      {
        Header: 'Categories',
        Cell: () => {
          return <Chip color="info" label="Petrol" size="small" variant="light" />;
        }
      },
      {
        Header: 'Price',
        Cell: () => {
          return <Chip label="₹ 12,000" size="small" variant="light" />;
        }
      },
      {
        Header: 'Qty',
